...
<body>
    ...
    <div class="back">
        ...
        <div class="create_table">
            ...
            <form action="../config/create_table.php" method="post">
                ...
                <label>
                    Nombre de la tabla
                    <input type="text" name="table_name" placeholder="usuarios">
                </label>
                ...
                <div class="columns" id="columns">
                    ...
                    <!-- 🔹 COLUMNA 1 -->
                    <div class="column">
                        <input type="text" name="columns[0][name]" placeholder="nombre_columna">
                        ...
                        <input type="number" name="columns[0][length]" placeholder="Longitud">

                        <label>
                            <input type="checkbox" name="columns[0][null]">
                            NULL
                        </label>

                        <label>
                            <input type="checkbox" name="columns[0][pk]">
                            PK
                        </label>

                        <label>
                            <input type="checkbox" name="columns[0][ai]">
                            AI
                        </label>
                ...
                <!-- ➕ AGREGAR COLUMNAS (luego lo haces dinámico con JS) -->
                <button type="button" id="addColumn">+ Agregar columna</button>

                <!-- 🔗 FOREIGN KEYS -->
                <h3>Relaciones (Foreign Keys)</h3>

                <div class="fks" id="fks">

                    <div class="fk" id="addFK">
                        <input type="text" name="fk[0][column]" placeholder="columna_local">

                        <input type="text" name="fk[0][ref_table]" placeholder="tabla_referencia">

                        <input type="text" name="fk[0][ref_column]" placeholder="columna_referencia">
                    </div>

                </div>

                <button type="button">+ Agregar relación</button>
    ...
    <script src="../config/DOM_create_table.js"></script>
</body>
</html>